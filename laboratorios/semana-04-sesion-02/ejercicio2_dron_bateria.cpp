...
class Dron {
    ...
    bool despegar(){
        ...
        std::cout<<"Dron despegando con "<<bateria.getNivelCargaPorc()<<"% de batería"<<std::endl;
        return true;
    }

    void descargar(int porcentaje){
        int restar=bateria.getNivelCargaPorc()-porcentaje;

        bateria.setNivelCargaPorc(restar);
    }
};
